...
// Printed Output 
console.log("Congratulations! According to your $" + X + "target salary and your associated costs of $" + X + "using your " + X + "hours that you gave as billable hours, your base rate of pay is $" + X + " !");