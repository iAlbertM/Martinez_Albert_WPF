...
// Givens
var workHrs = prompt("Weekly Hours\nHow many hours do you plan to spend working on the project each week?"); // Gathering estimated hours that will be billable
...
console.log("Based on your estimated " + workHrs + " hours a week dedicated to the project,\nMultiplied by your current hourly rate of $" + hourlyRate + ",\n you can quote the client: $" + wkProgress + " for the project");
